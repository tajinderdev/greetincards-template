                    ...
                    <div class="col-md-4">
                        <div class="card border-0">
                            <div class="card-body text-center">
                                ...
                                <div class="text-muted">0 New Items</div>
                    ...
                    <div class="col-md-4">
                        <div class="card border-0">
                            <div class="card-body text-center">
                                ...
                                <div class="text-muted">0 New Gifts</div>
                                <div class="progress mt-3" style="height: 5px">
                    ...
                    <div class="col-md-4">
                        <div class="card border-0">
                            <div class="card-body text-center">
                                ...
                                <div class="text-muted">0 Sales</div>
                                <div class="progress mt-3" style="height: 5px">
                    ...
                    <div class="col-md-4">
                        <div class="card border-0">
                            <div class="card-body text-center">
                                ...
                                <div class="text-muted">2 users</div>
                                <div class="progress mt-3" style="height: 5px">
                                    <div class="progress-bar bg-warning" role="progressbar" 
                                         aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                    ...
                    <div class="col-md-4">
                        <div class="card border-0">
                            <div class="card-body text-center">
                                ...
                                <div class="text-muted">0 Customers</div>
                                <div class="progress mt-3" style="height: 5px">
                                    <div class="progress-bar bg-warning" role="progressbar" 
                                         aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                    ...
                    <div class="col-md-4">
                        <div class="card border-0">
                            <div class="card-body text-center">
                                ...
                                <div class="text-muted">0 Items</div>
                                <div class="progress mt-3" style="height: 5px">
                                    <div class="progress-bar bg-warning" role="progressbar" 
                                         aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-custom mb-0" id="recent-products">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#">
                                        <img src="{{ url('assets/images/products/10.jpg') }}" class="rounded" width="40"
                                             alt="...">
                                    </a>
                                </td>
                                <td>Cookie</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#">
                                        <img src="{{ url('assets/images/products/7.jpg') }}" class="rounded" width="40"
                                             alt="...">
                                    </a>
                                </td>
                                <td>Glass</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#">
                                        <img src="{{ url('assets/images/products/8.jpg') }}" class="rounded" width="40"
                                             alt="...">
                                    </a>
                                </td>
                                <td>Headphone</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#">
                                        <img src="{{ url('assets/images/products/9.jpg') }}" class="rounded" width="40"
                                             alt="...">
                                    </a>
                                </td>
                                <td>Perfume</td>
